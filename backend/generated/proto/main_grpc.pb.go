...
const (
	...
	BankingService_GetBalancesPerDay_FullMethodName = "/BankingService/GetBalancesPerDay"
...
type BankingServiceClient interface {
	...
	GetBalancesPerDay(ctx context.Context, in *GetBalancesPerDayRequest, opts ...grpc.CallOption) (*GetBalancesPerDayResponse, error)
...
func (c *bankingServiceClient) GetBalancesPerDay(ctx context.Context, in *GetBalancesPerDayRequest, opts ...grpc.CallOption) (*GetBalancesPerDayResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBalancesPerDayResponse)
	err := c.cc.Invoke(ctx, BankingService_GetBalancesPerDay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BankingServiceServer interface {
	...
	GetBalancesPerDay(context.Context, *GetBalancesPerDayRequest) (*GetBalancesPerDayResponse, error)
...
func (UnimplementedBankingServiceServer) GetBalancesPerDay(context.Context, *GetBalancesPerDayRequest) (*GetBalancesPerDayResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBalancesPerDay not implemented")
}
...
func _BankingService_GetBalancesPerDay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBalancesPerDayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BankingServiceServer).GetBalancesPerDay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BankingService_GetBalancesPerDay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankingServiceServer).GetBalancesPerDay(ctx, req.(*GetBalancesPerDayRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BankingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBalancesPerDay",
			Handler:    _BankingService_GetBalancesPerDay_Handler,
		},
		{
...
func (c *budgetingServiceClient) GetTransactionById(ctx context.Context, in *GetTransactionByIdRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
	err := c.cc.Invoke(ctx, BudgetingService_GetTransactionById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *budgetingServiceClient) GetCategorizedTransactionResults(ctx context.Context, in *GetCategorizedTransactionResultsRequest, opts ...grpc.CallOption) (*GetCategorizedTransactionResultsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCategorizedTransactionResultsResponse)
	err := c.cc.Invoke(ctx, BudgetingService_GetCategorizedTransactionResults_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *budgetingServiceClient) AssociateTransaction(ctx context.Context, in *AssociateTransactionRequest, opts ...grpc.CallOption) (*AssociateTransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssociateTransactionResponse)
	err := c.cc.Invoke(ctx, BudgetingService_AssociateTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBudgetingServiceServer) GetTransactionById(context.Context, *GetTransactionByIdRequest) (*TransactionResponse, error) {
...
func _BudgetingService_GetTransactionById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTransactionByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BudgetingServiceServer).GetTransactionById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetingService_GetTransactionById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetingServiceServer).GetTransactionById(ctx, req.(*GetTransactionByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BudgetingService_GetCategorizedTransactionResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCategorizedTransactionResultsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BudgetingServiceServer).GetCategorizedTransactionResults(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetingService_GetCategorizedTransactionResults_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetingServiceServer).GetCategorizedTransactionResults(ctx, req.(*GetCategorizedTransactionResultsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BudgetingService_AssociateTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssociateTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BudgetingServiceServer).AssociateTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetingService_AssociateTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetingServiceServer).AssociateTransaction(ctx, req.(*AssociateTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _BudgetingService_GetTransactionById_Handler,
		},
		{
